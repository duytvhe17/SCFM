...
<body>
    ...
    <main>
        ...
        <div class="support-options">
            <a href="../student/createcomplaint" class="no-underline">
                <div class="option">
                    <i class="fa fa-plus fa-3x"></i>
                    <p>Create Complaint</p>
                </div></a>
            <a href="../student/viewAllQuestion" class="no-underline">
                <div class="option">
                    <i class="fa fa-list fa-3x"></i>
                    <p>View All Complaints</p>
                </div></a>
            <a href="../student/viewMyComplaintCompleted" class="no-underline">
                <div class="option">
                    <i class="fa fa-list fa-3x"></i>
                    <p>View My Complaints Completed</p>
                </div></a>
            <a href="../student/notification" class="no-underline">
                <div class="option">
        ...
        <div class="track-support">
            <!--            <button>Track the status of my complaints</button>-->
            <button type="button" onclick="location.href = '../student/mycomplaint';">Track the status of my complaints</button>
        </div>
